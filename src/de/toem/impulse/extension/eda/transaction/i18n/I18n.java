...
public class I18n extends de.toem.impulse.i18n.I18n { 
    ...
    public static String Serializer_ScvReader_IconId="";
    public static String Serializer_ScvReader_HelpURL="https://toem.de/index.php/resources/all-documents/205-Scv-reader";
    ...
    public static String Serializer_FtrReader_IconId="";
    public static String Serializer_FtrReader_HelpURL="https://toem.de/index.php/resources/all-documents/205-Scv-reader";
    ...
    public static String Processor_TlmPhaseAnalyzer_IconId="";
    public static String Processor_TlmPhaseAnalyzer_HelpURL="https://toem.de/index.php/resources/all-documents/205-Scv-reader";
    ...
    public static String Processor_Axi3Analyzer_IconId="";
    public static String Processor_Axi3Analyzer_HelpURL="https://toem.de/index.php/resources/all-documents/205-Scv-reader";
}
